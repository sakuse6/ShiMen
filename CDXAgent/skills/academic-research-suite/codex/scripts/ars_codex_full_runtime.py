...
QUESTION_RE = re.compile(r"\b(research question|rq|hypothesis|hypotheses)\b|研究问题|研究问题|假设|假设", re.IGNORECASE)
UNCLEAR_QUESTION_RE = re.compile(
    ...
    r"尚未.{0,20}(研究问题|研究问题)|没有.{0,20}(研究问题|研究问题)|没有.{0,20}(研究问题|研究问题)",
    re.IGNORECASE,
)
