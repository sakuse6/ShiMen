...
This rubric operationalizes their framework as a post-hoc observer signal for 扩展智能体运行环境 agents. It is used by `academic-pipeline/agents/collaboration_depth_agent.md` to score dialogue logs and produce **advisory, non-blocking** feedback to the user on how their collaboration pattern is shaping learning depth.
