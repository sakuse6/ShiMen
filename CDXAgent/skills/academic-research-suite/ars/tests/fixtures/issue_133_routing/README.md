...
- **100% pass on the current primary model** — the inherited 扩展智能体运行环境 session model (Opus 4.7 at the v3.9.2 ship; Fable 5 at the 2026-06 recalibration)
...
1. Start a fresh 扩展智能体运行环境 session in a clean workspace
