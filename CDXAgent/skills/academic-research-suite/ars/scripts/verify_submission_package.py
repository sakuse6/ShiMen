...
_REFS_TITLES = ("references", "bibliography", "参考文献")
...
# the 本文 prefix because bare 作者先前 matches 该作者先前 (a third party).
_SELF_CITATION_PHRASES = (
    ...
    "我们先前的研究", "我们过去的研究", "我们先前曾", "我们已于先前",
    "笔者先前的研究", "本研究团队先前", "本文作者先前",
)

_ACK_TITLE_RE = re.compile(r"acknowledg(?:e)?ments?|致谢", re.IGNORECASE)
