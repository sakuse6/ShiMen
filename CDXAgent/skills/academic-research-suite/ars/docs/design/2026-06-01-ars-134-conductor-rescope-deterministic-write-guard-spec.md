...
A new `PreToolUse` hook (added to `hooks/hooks.json`, which today carries only a SessionStart announce). First-party verified against official 扩展智能体运行环境 hook docs (2026-06-01):
