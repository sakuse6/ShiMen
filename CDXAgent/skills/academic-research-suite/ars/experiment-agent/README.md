...
[繁体中文版](README.zh-TW.md)

A 扩展智能体运行环境 skill for executing, monitoring, interpreting, and verifying experiments in academic research.
...
**Step 2**: When you need to run experiments, open a 扩展智能体运行环境 session **in the experiment-agent directory**:
...
> You can also add this skill to any project via `.claude/skills/` symlink — see [扩展智能体运行环境 docs](https://docs.anthropic.com/en/docs/claude-code) for skill installation.
